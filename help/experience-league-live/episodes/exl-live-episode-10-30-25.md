...
在這個Experience League即時工作階段中，我們推出了&#x200B;**Adobe Journey Optimizer Experimentation Accelerator** — 這是新的AI優先應用程式，其建置可轉變實驗、產品和成長團隊測試、學習及最佳化行銷活動和客戶歷程的方式。

此新應用程式由&#x200B;**Adobe Experience Platform Experimentation Agent**&#x200B;提供技術支援，可自動進行實驗分析，同時減少手動操作，讓團隊能夠：
