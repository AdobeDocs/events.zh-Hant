...
在這集Experience League LIVE中，我們的專家會隨著我們步入新的代理時代，帶您瞭解最新的Adobe Target創新內容。 我們介紹新的Target MCP，包括內容、存取方法，以及如何使用代理程式分析方案見解及建置和編輯活動。 我們也會分享其他新功能和增強功能的示範，這些功能和增強功能旨在協助您擴充最佳化規模。
