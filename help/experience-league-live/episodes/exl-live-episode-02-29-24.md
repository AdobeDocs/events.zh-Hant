---
title: 全新 Adobe Campaign Web 使用者介面助您一臂之力
...
# 全新 Adobe Campaign Web 使用者介面助您一臂之力

Adobe Campaign v8將具有全新的外觀。 重新想像的使用者體驗簡化了行銷活動設計流程，並且與其他Adobe Experience Cloud解決方案一致。

加入這場Experience League Live研討會，Adobe Campaign產品專家將展示如何在新的使用者體驗中規劃、啟動和衡量跨管道行銷活動。
...
* 全新的Adobe促銷活動網頁使用者介面已推出，供使用Adobe Campaign 8.6版本的客戶使用。
...
* **[Adobe Campaign Web使用者介面 — 教學課程](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/overview.html?lang=zh-Hant){target="_blank"}**
