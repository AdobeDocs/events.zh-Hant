...
>[!VIDEO](https://video.tv.adobe.com/v/3455461/?captions=chi_hant&learn=on)

## 要點

* 在Adobe Acrobat Sign中建立網路表單前，請確定您已登入帳戶並啟用必要設定。
* 可以在帳戶層級或特定使用者群組啟用網路表單的設定。
* 網路表單設定的選項包括允許網路表單、啟用副本收件者、PDF預覽、要求簽名區塊有電子郵件裙子，以及簽名者的電子郵件驗證。
...
* Adobe提供說明中心、Experience League、支援社群、技能建立網路研討會和資源中心等資源，以進一步瞭解檔案流程。
