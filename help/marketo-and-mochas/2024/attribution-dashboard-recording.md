...
description: 加入Adobe資深業務顧問Cynthia Chang和技術顧問James Leedom，深入瞭解如何掌握Marketo的歸因模型和效能分析(MPI)儀表板，涵蓋設定、方案追蹤、資料同步，並展示行銷對收入和客戶贏取的影響。
...
在這場會議中，Adobe的資深業務顧問Cynthia Chang和技術顧問James Leedom將帶領我們概略瞭解您需要瞭解的有關Marketo歸因模型的一切，以及使用原生Marketo效能深入分析(MPI)儀表板可以完成哪些工作。
