---
title: 在Edge Delivery Services中製作
...
在這場中午風格的對決中，您將觀看Document-Based Authoring和Universal Editor與AEM Sites在Edge Delivery Services前沿的對手槍手對決 — 他們各自努力證明這是建立體驗的最快速和最強大的方式。 透過即時比較和實務案例，您將會瞭解每種方法各自在哪些方面成效顯著、在哪些方面發生誤導，以及它如何影響您的團隊、控管和上市速度。 當塵埃落定時，縣長（檔案製作）馬上介入，讓事情變得有序，向客戶展示如何將各種方法結合成現代、未來可行的製作策略。
