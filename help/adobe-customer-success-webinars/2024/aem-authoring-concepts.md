...
認識到在擴展內容產生方面的挑戰，例如對內容需求的增長、全通道內容提供的需求以及推動內容ROI的重要性。 &#x200B;

### 製作功能

AEM中各種撰寫工具的概觀、

* **頁面編輯器**&#x200B;建立及編輯網頁的傳統WYSIWYG編輯器。 &#x200B;
* **內容片段編輯器**&#x200B;用於建立可跨不同管道重複使用的Headless內容。 &#x200B;
* **通用編輯器**&#x200B;內容建立的現代化UI支援AEM內容和正確檢測的外部內容。 &#x200B;
* **檔案式製作**&#x200B;允許使用熟悉的工具（例如Microsoft Word或Google Docs）建立內容，並與AEM工作流程整合。 &#x200B;
