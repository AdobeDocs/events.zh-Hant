...
瞭解如何移轉至Adobe Real-time Customer Data Platform以及需要多少工作，
...
此網路研討會會討論從現有CDP （例如Adobe Audience Manager）到即時CDP （客戶資料平台）的演變，例如Adobe的Real-time CDP。 此會議著重於向與會者介紹影響資料管理策略的業界趨勢、為組織內的發展做好準備，並提供使用CDP定義未來證據資料管理方法的建議。
