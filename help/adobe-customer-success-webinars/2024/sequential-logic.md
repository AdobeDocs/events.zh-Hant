...
description: 在AA和CJA中掌握循序細分和篩選器，包括基礎層面、實務範例和業務應用程式，如Andy Powers的工作階段中所述。
...
對Adobe Analytics （循序區段）和Customer Journey Analytics （循序篩選器）中的THEN及相關循序邏輯運運算元有基本的瞭解。 循序邏輯可在Adobe Analytics和Customer Journey Analytics中啟用高價值分析，但運用率偏低，且常有誤解。 此網路研討會將為如何在Analysis Workspace中評估這些運運算元奠定基礎。

>[!VIDEO](https://video.tv.adobe.com/v/3442925/?learn=on&enablevpops)

## 重點提要

* **工作階段焦點**&#x200B;工作階段專注於在Andy Powers領導的Customer Journey Analytics (CJA)中掌握循序邏輯和分析。
* **循序邏輯基本概念**&#x200B;工作階段涵蓋Analytics和CJA中循序區段和篩選的基本層面，包括：
...
* **資源**&#x200B;已提供循序區段或篩選器的Analytics和CJA兩端的資源連結，以供進一步研究。
