...
+ Analytics {#analytics}
   + 2023 版 {#2023}
      + [具影響力的資料視覺效果](analytics/2023/impactful-data-visualizations.md)
      + [解鎖Adobe Analytics中處理規則的強大功能](analytics/2023/processing-rules.md)
...
+ Experience Manager {#experience-manager}
   + 2026 {#2026}
      + [在AEM和EDS中正確使用AI](experience-manager/2026/ai-aem-eds.md)
      + [使用Dynamic Media擴充全通路體驗](experience-manager/2026/omnichannel-dynamic-media.md)
   + 2025 版 {#2025}
...
+ Marketo {#marketo}
   ...
   + 2024 年 {#2024}
      ...
      + [Marketo Engage REST API的實際應用](marketo/2024/practical-applications-of-marketo-engage-rest-api.md)
      + [使用Marketo Engage的個人得分掌握](marketo/2024/person-scoring-mastery.md)
   + 2023 版 {#2023}
      + [Marketo Engage和Dynamic Chat](marketo/2023/dynamic-chat.md)
      + [使用Marketo Engage提升電子郵件傳遞能力](marketo/2023/email-deliverability.md)
      + [追蹤、分析和最佳化您的行銷活動](marketo/2023/marketing-campaigns.md)
      + [使用 [!DNL Marketo Engage]在規模程式碼中解密Personalization](marketo/2023/personalization-at-scale.md)
...
+ Workfront {#workfront}
   ...
   + 2023 版 {#2023}
      ...
      + [與一般使用者通訊](workfront/2023/communicating-with-end-users.md)
      + [建立Workfront卓越中心](workfront/2023/establishing-a-workfront-center-of-excellence.md)
      + [專案範本基礎](workfront/2023/foundations-of-project-templates.md)
      + [在Workfront自動化中尋找效率](workfront/2023/finding-efficiencies-in-workfront-automation.md)
      + [透過介面設計改善使用者體驗](workfront/2023/improving-user-experience-with-interface-design.md)
      + [接管現有Workfront執行個體的秘訣](workfront/2023/tips-for-taking-over-an-existing-workfront-instance.md)
   + 2022 版 {#2022}
      + [在Workfront中瀏覽變更管理](workfront/2022/navigating-change-management.md)
      + [成功的使用者採用](workfront/2022/successful-end-user-adoption.md)
      + [工作流程和流程設計](workfront/2022/workflow-and-process-design.md)
      + [資源管理快速入門](workfront/2022/getting-started-with-resource-management.md)
      + [系統維護和清理](workfront/2022/system-maintenance-and-cleanup.md)
      + [關於請求佇列](workfront/2022/all-about-request-queues.md)
