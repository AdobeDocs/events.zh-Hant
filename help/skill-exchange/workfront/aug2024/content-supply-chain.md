---
title: Workfront的Supply chain行銷內容
description: 美泰如何將其內容Supply chain流程對應至Workfront他們識別用於測量端對端效能的KPI他們為資產生產設定的一對多關係   透過Workfront Planning進一步瞭解他希望如何發展其行銷活動策略流程
solution: Workfront
...
# Workfront的Supply chain行銷內容

如果您在行銷部門，在維持品質及預算有限的同時，要求更快速製作內容的壓力持續增加。 兩年前，美泰就感受到了這種實實在在的壓力，與Workfront合作，建立了同級最佳的解決方案。

美泰整合行銷通訊群組流程與平台管理資深經理Gardner將分享他們如何處理此流程變更，並為行銷人員規劃、執行和衡量美泰行銷內容Supply chain打造有效的解決方案。 具體而言，Neal將分享：

* 美泰公司如何著手將他們的內容Supply chain流程對應至Workfront
* 他們識別的用於測量端對端效能的KPI
* 資產生產的一對多關係設定
