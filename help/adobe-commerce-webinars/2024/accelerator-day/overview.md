...
2024年5月7日，Adobe與澳洲聯邦銀行(CBA)合作，在雪梨的CBA禮堂招待客戶和合作夥伴。 這次活動是圍繞Adobe Commerce、Adobe Experience Cloud和聯邦銀行針對PowerBoard支付協調平台最新支付開發的一整天創新會議。
...
| **體驗演化： Commerce、資料與您** | 使用[!DNL Real-Time Customer Data Platform]、[!DNL Journey orchestration]和整合的Commerce [!DNL Experience Platform]的Adobe個人化概觀和示範 | <ul><li>Mike Lynch - Adobe企業[!DNL Commerce]專家</li></ul> | [觀看影片](./experience-evolution.md) |
...
| **新一代Commerce： Gen AI應用程式的興起** | Commerce中的AI概述和示範(Adobe透過[!DNL Adobe Express]的最新創作AI)，以及如何將其用於現實世界的商務和內容團隊。 | <ul><li>Eroka O&#39;Connor - Adobe資深解決方案顧問</li></ul> | [觀看影片](./next-gen-commerce.md) |
...
| **閃電般速度： Adobe的邊緣傳遞服務** | 透過Adobe Experience Manager和Adobe Commerce展示Adobe極速的Edge Delivery Services的最新詳細資訊和示範 | <ul><li>Kam Radhakrishnan - Adobe資深解決方案工程師</li></ul> | [觀看影片](./lightning-speed.md) |
| **可組合性： App Builder、API Mesh與Headless** | 概述Adobe Commerce和App Builder平台的最新發展，透過Headless可撰寫創新實現數位體驗的延伸 | <ul><li>Jason Ford - Adobe澳新銀行解決方案工程總監</li></ul> | [觀看影片](./composability.md) |
| **跨頻道交響樂：編排Commerce Excellence** | 由Adobe的Matt Palmer主持的壁爐邊聊天，探討DotDigital如何與Adobe Commerce合作，推動創新、個人化和一對一傳訊 | <ul><li> Matt Palmer - Adobe資深合作夥伴銷售經理</li><li>Graham Bell - DotDigital澳新銀行銷售主管</li></ul> | [觀看影片](./cross-channel-symphony.md) |
| **Commerce的藝術** | 在Adobe Commerce上展示即時客戶範例，展示最尖端的功能，讓解決方案合作夥伴的創新成為最前沿 | <ul><li>Carl Screwvala - Adobe資深解決方案工程師</li></ul> | [觀看影片](./the-art-of-commerce.md) |
