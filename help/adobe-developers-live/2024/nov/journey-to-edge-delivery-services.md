...
加入Adobe合作夥伴Ensemble的軟體開發主管Mark McConnell，分享將客戶帶入Edge Delivery Services生態系統的範例。 瞭解這項創新如何補充Adobe Experience Manager投資，協助實現真實世界的成功。
...
* **簡報者與背景** Mark McConnell，Ensemble的軟體開發人員，使用Adobe產品與PGA導覽討論他們的工作。
* **專案概述** Ensemble已與PGA Tour合作超過三年，開發其主要網站、行動應用程式和各種錦標賽專用網站。
* **使用的技術**&#x200B;重點在於使用Adobe Experience Manager (AEM) Headless和Edge傳送服務，以符合PGA導覽的需求。
...
* Ensemble、PGA導覽、Adobe之間的&#x200B;**成功因素** Collaboration，以及AEM網站與邊緣傳送服務之間的協同效應，促成了他們的成功。
