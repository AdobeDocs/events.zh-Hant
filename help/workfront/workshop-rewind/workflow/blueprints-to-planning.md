---
title: 啟用可縮放功能 — 將Workfront藍圖轉換為真實世界的訓練計畫
description: 瞭解如何將Workfront藍圖轉換為實用的訓練計畫，以有效擴展啟用範圍。
...
# 啟用可縮放功能 — 將Workfront藍圖轉換為真實世界的訓練計畫

隨著組織成長，上線、培訓和支援使用者的複雜性也會增加。 適合小型試驗團隊的內容通常會大規模失效。 這是Adobe Workfront藍圖和專案範本可提供結構、一致性和速度的地方。 在這場會議中，我們探索了Workfront如何驅動引擎進行培訓和賦能，由Blueprint提供技術支援。
