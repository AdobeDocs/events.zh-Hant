---
title: 從自學到成功 — Kyndryl如何將Workfront擴充到70億美元
description: 車間倒帶 — 工作流程
...
# 從自學到成功：Kyndryl如何擴充Workfront至70億美元

這次研討會是與Rachel Small和Kyndryl的Bill McCandless合作舉辦，會議概述了Kyndryl的內部創意團隊如何採取自我學習的方法，建立可支援70億美元全球業務的Workfront模型。 他們使用專案範本、自訂表單、報告和儀表板等原生Workfront功能，設計並調整內容營運架構，以平衡速度、可見度和治理。

>[!VIDEO](https://video.tv.adobe.com/v/3477160/?learn=on&enablevpops)

[Kyndryl投影片組PDF](https://workfront-experience.s3.us-west-2.amazonaws.com/Training/Guides/Customer+Success+at+Scale/Abobe-Kyndryl-Webinar.pdf)

從他們從其他Workfront客戶那裡學到的經驗中，我們可以很棒的瞭解Workfront社群是多麼強大（和慷慨）。
