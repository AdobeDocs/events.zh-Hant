---
title: Workfront管理員角色內 — 前兩年的10堂課
description: 探索身為Workfront管理員兩年期間的主要課程。 獲得實用的提示和見解以增強您的管理員技能並簡化工作流程。
...
# Workfront管理員角色內 — 前兩年的10堂課

加入Aramark的Adobe Workfront應用程式負責人Jen Mancini，探索兩年期間在Workfront管理員角色中學到的重要課程。 獲得實用的建議和可行的策略以改善工作流程和團隊效率。

觀看隨選錄製，從她在此過程中的實際經驗與實務經驗中學習，包括入職和變更管理，以協助其他人成長並成功擔任Workfront管理員。
