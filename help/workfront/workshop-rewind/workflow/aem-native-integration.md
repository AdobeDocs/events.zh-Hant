---
title: 善用Workfront + AEM原生整合
description: 此活動提供整合概述、如何準備（包括對應程式、協調中繼資料、確保適當許可權等）的深入分析，以及設定該整合的逐步解說。
topic: Integrations
...
加入Myka Bohnsack和Warren Barton，分享他們在Workfront + AEM原生整合活動上的專業知識！

>[!VIDEO](https://video.tv.adobe.com/v/3477157/?learn=on&enablevpops)

如果您錯過現場活動，請檢閱[投影片組](https://workfront-experience.s3.us-west-2.amazonaws.com/Training/Guides/Customer+Success+at+Scale/AEM-WF_Native_Integration_10-23-25.pdf)並觀看隨選錄製。 此活動提供整合概述、如何準備（包括對應程式、協調中繼資料、確保適當許可權等）的深入分析，以及設定該整合的逐步解說。
