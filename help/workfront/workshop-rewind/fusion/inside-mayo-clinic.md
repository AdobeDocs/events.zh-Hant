---
title: Mayo診所內 — Workfront Fusion如何協助人類
description: 深入瞭解Mayo Clinic如何使用Workfront Fusion來轉換運作方式的6個不同使用案例。
...
# Mayo診所內：Workfront Fusion如何協助人類

這場研討會是與Mayo Clinic的Tia Calvert和Matt Lien合作舉辦，透過內部檢視6種使用案例，瞭解Mayo Clinic如何使用Workfront Fusion來轉換運作方式。
...
Fusion需要時間和練習，所以如果您剛開始使用，請進一步瞭解Experience League[的（免費！） &#x200B;](https://experienceleague.adobe.com/zh-hant/docs/workfront-learn/tutorials-workfront/fusion/welcome-to-workfront-fusion/workfront-fusion-overview)Fusion訓練，並隨時與[Workfront Fusion社群](https://experienceleaguecommunities.adobe.com/t5/workfront-fusion/ct-p/workfront-fusion-2)上的其他客戶取得協助。
