...
加入Schneider Electric和Adobe Workfront Champion的Creative營運專家Kimberly Rea，一同分享Schneider Electric如何使用自訂Forms和Fusion Scenarios來自動化工作流程並追蹤自動化接觸點的數量，協助量化影響並建立擴大自動化規模的案例。
