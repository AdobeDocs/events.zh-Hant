...
讓我們來談談採用！ 我們正在尋找新鮮的想法，瞭解如何讓我們的新使用者興奮地登入Workfront，所以為什麼不考慮使用面板？
...
* [開始使用Adobe Workfront中的面板](https://experienceleague.adobe.com/docs/workfront/using/agile/boards-in-workfront/get-started-with-boards.html?lang=zh-Hant)
