...
description: 從Nichole Vargas學習最佳報告實務 — 使用計算欄位、storytelling提示和社群導向的資源提升您的Workfront報告技能。
...
>[!VIDEO](https://video.tv.adobe.com/v/3469976/?captions=chi_hant&learn=on&enablevpops)
...
* **Article** - [計算的資料運算式]（https://experienceleague.adobe.com/docs/workfront/using/reporting/reports/calculated-custom-data/calculated-data-expressions.html?lang=zh-Hant#:~:text=您可以使用產生新欄位的資料運算式。&amp;text=如需有關建立的詳細資訊，請將資料放入自訂表單。）
