...
* **Article** - [計算的資料運算式]（https://experienceleague.adobe.com/docs/workfront/using/reporting/reports/calculated-custom-data/calculated-data-expressions.html?lang=en#:~:text=您可以使用產生新欄位的資料運算式。&amp;text=如需有關建立的詳細資訊，請將資料放入自訂表單。）
