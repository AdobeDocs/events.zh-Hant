...
+ 車間倒帶 {#workshop-rewind}
   + Fusion {#fusion}
      ...
      + [McKesson Fusion資源自動化](workshop-rewind/fusion/mckesson-fusion-automation.md)
   ...
   + 工作流程 {#workflow}
      ...
      + [增強的自訂Forms和本地化](workshop-rewind/workflow/enhanced-logic-localization.md)
      ...
      + [Workfront價值最大化](workshop-rewind/workflow/value-realization.md)
      + [克服變革的阻力](workshop-rewind/workflow/overcome-resistance-to-change.md)
...
+ 快速取得 {#quicktakes}
   + 前3名 {#top3}
      + [建立共用欄報告](quick-takes/top3/shared-column-report.md)
      + [使用Blueprint的Creative方法](quick-takes/top3/blueprints.md)
      + [Creative使用Workfront面板的方式](quick-takes/top3/creative-approaches-boards.md)
      + [開始使用Workfront面板範本](quick-takes/top3/get-started-board-templates.md)
      + [在Workfront中將報表排程最大化](quick-takes/top3/report-scheduling.md)
      + [使用公司的理由](quick-takes/top3/why-use-companies.md)
      + [開始使用里程碑](quick-takes/top3/get-started-milestones.md)
      + [參加Workfront研討會的重要原因](quick-takes/top3/reason-attend-workshop.md)
      + [使用版面配置範本的幾大理由](quick-takes/top3/layout-templates.md)
      + [資源集區的主要原因](quick-takes/top3/resource-pools.md)
      + [前3大辦公時間方法](quick-takes/top3/office-hours.md)
      + [3大行事曆攻略](quick-takes/top3/calendar-hacks.md)
      + [使用Workfront面板的3大理由](quick-takes/top3/boards-for-adoption.md)
      + [在自訂Forms中使用影像](quick-takes/top3/add-image-custom-forms.md)
      + 監視我的工作 {#watchmework}
         + [Workfront重要秘訣](quick-takes/top3/watch-me-work-1.md)
         + [主要專案管理功能](quick-takes/top3/watch-me-work-2.md)
...
+ 專家深入分析 {#expert-insights}
   ...
   + [執行個體的演化](expert-insights/evolution-of-an-instance.md)
