...
* Assets Essentials
   * 具有工作管理與Assets Essentials的CCEPro
   * 權限管理
   * 公用連結共用
* 網站
   * 內容模型中的可翻譯欄位
...
對此版本有任何問題嗎？  在[Experience League社群](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/aem-as-a-cloud-service-2022-3-0-release-update/td-p/449599)中討論此版本。
