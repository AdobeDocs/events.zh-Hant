...
活動提供了Adobe Experience Manager的更新，包括引入即時副本或多站點管理員功能，讓使用者能夠輕鬆管理變化多處的內容。 此&#x200B;外，此事件還展示了資產管理新的Firefly增強功能，讓使用者在找不到搜尋結果時產生新資產。 此&#x200B;外，我們引進了動態媒體範本，以透過有效率地變更值，簡化建立多個橫幅的程式。 此&#x200B;活動也突顯了適用於AM表單的新Jenn-air系統，提供早期採用者存取權以加快表單建立流程。 最&#x200B;後，也提供Cloud Manager的增強功能，例如邊緣傳遞服務支援和網域驗證的DB憑證，以簡化專案部署。 &#x200B;
